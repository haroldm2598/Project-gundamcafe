...
export const footerComponent = () => {
	const footerObj = [
		{
			title: 'Gundam Cafe',
			icons: [
				`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 496 512' height='2em' width='2em'>
			...
			// icons: ['fa-facebook', 'fa-github', '-fa-twitter', 'fa-instagram'],
	...
	for (let i = 0; i < footerObj.length; i++) {
		...
		// fa.setAttribute('class', `fa-brands ${footerObj[i].icons}`);

		para1.textContent = footerObj[i].title;
		para2.textContent = footerObj[i].date;
		li.innerHTML = footerObj[i].icons;
